      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5">
                ...
                <div className="bg-white rounded-[2rem] p-8 border border-gray-200 shadow-lg relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-[#00B67A]/10 rounded-bl-full -mr-8 -mt-8"></div>
                    
                    <div className="relative z-10">
                        <div className="w-12 h-12 bg-[#00B67A] rounded-2xl flex items-center justify-center text-white mb-6 shadow-md shadow-green-500/20">
            ...
            <div className="lg:col-span-7">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {/* Card 1 */}
                    <div className="bg-white p-8 rounded-[2rem] border border-gray-100 hover:border-gray-300 hover:shadow-md transition-all duration-300">
                        ...
                        <p className="text-sm text-gray-500 font-medium leading-relaxed">
                            We use original equipment manufacturer (OEM) parts to ensure your appliance runs exactly as the factory intended.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-[2rem] border border-gray-100 hover:border-gray-300 hover:shadow-md transition-all duration-300">
                        ...
                        <p className="text-sm text-gray-500 font-medium leading-relaxed">
                            If we can't identify the problem or fix your appliance, you don't pay for the service call. Simple as that.
                        </p>
                    </div>
                    ...
                    {/* Card 4 */}
                    <div className="bg-[#1D1D1B] p-8 rounded-[2rem] border border-gray-800 relative overflow-hidden group">
                        <div className="relative z-10">
                            ...
                            <p className="text-sm text-gray-400 font-medium leading-relaxed mb-4">
                                Extend your coverage to 1 year with our preventative maintenance club.
                            </p>
                            <a href="tel:8187310445" className="inline-flex items-center gap-2 text-[#FDC506] font-bold text-xs uppercase tracking-widest hover:underline">
                                Learn More <ShieldCheck size={12} />
                            </a>
                        </div>
                    </div>
