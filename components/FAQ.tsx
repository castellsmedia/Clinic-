...
const FAQItem: React.FC<FAQItemProps> = ({ q, a, icon, color, isOpen, toggle, idx }) => {
  return (
    <div 
      onClick={toggle}
      className={`group relative bg-white rounded-[2rem] p-6 md:p-8 cursor-pointer border transition-all duration-500 ${
        isOpen 
    ...
    >
      <div className="flex items-start justify-between gap-6">
        ...
        <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 transition-colors duration-300 ${
            isOpen ? `bg-[${color}] text-white` : `bg-gray-50 text-[${color}]`
